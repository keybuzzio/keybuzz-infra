...
sed -i 's|ghcr.io/keybuzzio/keybuzz-client:v3.5.51-always-burger-menu-dev|ghcr.io/keybuzzio/keybuzz-client:v3.5.52-order-panel-toggle-dev|' "$DEPLOY"
...
git commit -m "feat(dev): order panel toggle button (v3.5.52)"
git pull --rebase origin main
git push origin main

echo ""
echo "=== Deploy DEV ==="
kubectl set image deploy/keybuzz-client keybuzz-client=ghcr.io/keybuzzio/keybuzz-client:v3.5.52-order-panel-toggle-dev -n keybuzz-client-dev
