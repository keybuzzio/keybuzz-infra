#!/usr/bin/env python3
"""Test de récupération des secrets Vault pour KeyBuzz API"""
...
print("=== Test Vault Secrets pour KeyBuzz API ===")
print(f"Vault Address: {vault_addr}")
print()

role_id, secret_id = load_approle_creds('keybuzz-api')
...
secrets_to_test = [
    'keybuzz/apps/keybuzz-api/postgres-url',
    'keybuzz/apps/keybuzz-api/redis-url',
    'keybuzz/apps/keybuzz-api/rabbitmq-url',
    'keybuzz/apps/keybuzz-api/jwt-secret',
]
