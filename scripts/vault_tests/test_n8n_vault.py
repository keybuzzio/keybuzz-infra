#!/usr/bin/env python3
"""Test de récupération des secrets Vault pour n8n"""
...
print("=== Test Vault Secrets pour n8n ===")
print(f"Vault Address: {vault_addr}")
print()

role_id, secret_id = load_approle_creds('n8n')
...
secrets_to_test = [
    'keybuzz/apps/n8n/rabbitmq-url',
    'keybuzz/apps/n8n/redis-url',
    'keybuzz/apps/n8n/webhook-secret',
    'keybuzz/apps/n8n/jwt-secret',
]
