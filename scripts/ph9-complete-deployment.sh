#!/bin/bash
# PH9-COMPLETE-DEPLOYMENT - Complete deployment after reset
set -e

cd /opt/keybuzz/keybuzz-infra

LOG_FILE="/opt/keybuzz/logs/phase9-reset/ph9-complete-deployment.log"
...
echo "[INFO] =========================================="
echo "[INFO] PH9-COMPLETE-DEPLOYMENT"
echo "[INFO] =========================================="
echo ""

# Step 1: Get join commands from master-01
echo "[INFO] Step 1: Getting join commands from master-01..."
...
# Step 5: Wait for Calico to be ready
echo "[INFO] Step 5: Waiting for Calico to be ready..."
for i in {1..60}; do
    ...
    if [ "$CALICO_READY" -ge 2 ] && [ "$CALICO_READY" -eq "$CALICO_TOTAL" ] && [ "$CALICO_TOTAL" -gt 0 ]; then
...
echo ""
echo "[INFO] =========================================="
echo "[INFO] ✅ PH9-COMPLETE-DEPLOYMENT Complete"
echo "[INFO] =========================================="
echo ""
