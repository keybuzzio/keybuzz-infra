#!/bin/bash
# PH9-JOIN-ALL-NODES - Join all masters and workers to cluster
set -e

cd /opt/keybuzz/keybuzz-infra

LOG_FILE="/opt/keybuzz/logs/phase9-reset/ph9-join-all-nodes.log"
...
echo ""
echo "[INFO] =========================================="
echo "[INFO] ✅ PH9-JOIN-ALL-NODES Complete"
echo "[INFO] =========================================="
echo ""
